...
public class Client {
	...
	///////////////////////////////////////////////////////terzo utente
			...
			Metadata metadata_utente3=new Metadata(attribute,fs_utente3,OpenVeristicInterpretation.getinstance());
			...
			if(e instanceof MetadataWithSameAttributeException){
				System.out.println("Stai cercando di aggiungere ad un descrittore uno o più medatadati con lo stesso attributo.");
			}
